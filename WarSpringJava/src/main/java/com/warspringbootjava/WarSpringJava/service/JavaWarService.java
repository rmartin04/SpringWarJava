...
public class JavaWarService {
    ...
    private NaveDestructoraBean crearNave()
        ...
        List<Guerrero> guerreros = crearGuerreros(() -> new Guerrero("Bicho", 6, 4), 10);
        NaveDestructoraBean nave = new NaveDestructoraBean("Nostromo", "U.S.C.S.S", 6, 4, guerreros);
    ...
    private TanqueBean crearTanque()
            throws FuerzaYResistenciaException, FuerzaGuerreroException, ResistenciaGuerreroException, Exception {
        List<Guerrero> guerreros = crearGuerreros(() -> new Guerrero("Soldado", 6, 4), 10);
        TanqueBean tanque = new TanqueBean("el tigre real", "T-34", 6, 3, guerreros);
